...
export default function ObsidianLessonsPage() {
  ...
  const filteredLessons = obsidianLessons.filter(lesson =>
  ...
  const handleConfirmSchedule = async () => {
    ...
    const lesson = obsidianLessons.find(l => l.id === selectedLesson)
          ...
          <Card key={lesson.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="flex gap-2">
                <Link href={`/categories/lectures/obsidian/${lesson.id}`}>
