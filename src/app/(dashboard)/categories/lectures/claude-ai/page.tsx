...
export default function ClaudeLessonsPage() {
  ...
  const filteredLessons = claudeLessons.filter(lesson =>
  ...
  const handleConfirmSchedule = () => {
    alert(`${selectedLesson}강이 ${scheduleDate} ${scheduleTime}에 발행 예약되었습니다.`)
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Claude AI 강좌</h1>
        <Badge variant="secondary" className="text-lg px-4 py-2">
          총 {claudeLessons.length}개 강좌
        </Badge>
      </div>
          ...
          <Card key={lesson.id} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="flex gap-2">
                <Link href={`/categories/lectures/claude-ai/${lesson.id}`}>
