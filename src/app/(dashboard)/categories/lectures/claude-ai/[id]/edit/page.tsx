...
import { ChevronLeft, Save, Image, Eye, Calendar, Sparkles } from "lucide-react"
import Link from "next/link"
import { ScreenshotCollector } from "@/components/screenshot-collector"
...
export default function ClaudeLessonEditPage({ params }: PageProps) {
  ...
  useEffect(() => {
    async function loadLesson() {
      ...
      const lesson = getClaudeLesson(parsedId)
      if (!lesson) {
        notFound()
      }
      ...
      // 기본 콘텐츠 설정
      setContent(`<h1>${lesson.title}</h1>
<p>${lesson.description}</p>
<p>Claude AI 강좌 내용이 여기에 표시됩니다.</p>`)
    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <Link href={`/categories/lectures/claude-ai/${lessonId}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">실시간 미리보기</h3>
